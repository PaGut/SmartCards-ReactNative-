...
export default class CameraScreen extends React.Component {
    ...
    onPictureSaved = async photo => {
        ...
        // save picture to google firebase
        /*this._uploadImageToFirebase(photo.uri).
            then(url => { alert('uploaded'); this.setState({ image_uri: url }); this.props.onClose(); })
            .catch(error => console.log(error))*/
        // close camera screen after picture was made
    ...
    _uploadImageToFirebase = (uri, mime = 'application/octet-stream') => {
    ...
    render() {
        ...
        return <Modal visible={this.props.visible} style={styles.container}>{content}</Modal>;
    }
}
